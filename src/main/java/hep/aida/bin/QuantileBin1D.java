...
Thus, data cannot be thrown away during filling (as done by static bins like {@link hep.aida.bin.StaticBin1D} and {@link hep.aida.bin.MightyStaticBin1D}).
...
As a consequence, traditional methods either need very large memories (like {@link hep.aida.bin.DynamicBin1D}) or time consuming disk based sorting.
<p>
 ...
 * They are identical to the one's defined in the constructor of the parent class {@link hep.aida.bin.MightyStaticBin1D}.
 * <p>
...
Objects of subclasses may <i>always</i> compute exact quantiles, as is the case for {@link hep.aida.bin.DynamicBin1D}.
...
Then lets {@link #splitApproximately(cern.colt.list.DoubleArrayList,int)} do the real work.
