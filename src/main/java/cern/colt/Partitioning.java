...
<tt>(a,b)</tt>, namely an {@link cern.colt.function.IntComparator}.
...
@see Sort
@see Sort#sort(int,int, cern.colt.function.IntComparator,Swapper)
@see cern.colt.Sorting#binarySearchFromTo(int,int, cern.colt.function.IntComparator)
*/
