...
<b>Implementation</b>:
<p>
Almost all methods are expressed in terms of {@link #forEachKey(cern.colt.function.LongProcedure)}.
 ...
 * Iteration order is guaranteed to be <i>identical</i> to the order used by method {@link #forEachKey(cern.colt.function.LongProcedure)}.
 *
 * @param procedure    the procedure to be applied. Stops iteration if the procedure returns <tt>false</tt>, otherwise continues. 
 * @return <tt>false</tt> if the procedure stopped before all keys where iterated over, <tt>true</tt> otherwise. 
 */
 ...
 * Search order is guaranteed to be <i>identical</i> to the order used by method {@link #forEachKey(cern.colt.function.LongProcedure)}.
 *
