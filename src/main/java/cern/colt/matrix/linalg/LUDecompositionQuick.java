...
Upon return <tt>A</tt> is overridden with the result <tt>LU</tt>, such that <tt>L*U = A</tt>.
Currently supports diagonal and tridiagonal matrices, all other cases fall through to {@link #decompose(cern.colt.matrix.DoubleMatrix2D)}.
...
@see #triangulateUpper(cern.colt.matrix.DoubleMatrix2D)
*/
