...
/**
 * Linear algebraic matrix operations operating on {@link cern.colt.matrix.DoubleMatrix2D}; concentrates most functionality of this package.
 *
...
public class Algebra extends cern.colt.PersistentObject {
	/**
	 * A default Algebra object; has {@link cern.colt.matrix.linalg.Property#DEFAULT} attached for tolerance.
	...
	/**
	 * A default Algebra object; has {@link cern.colt.matrix.linalg.Property#ZERO} attached for tolerance.
	 * Allows ommiting to construct an Algebra object time and again.
	 * 
	 * Note that this Algebra object is immutable.
	 * Any attempt to assign a new Property object to it (via method <tt>setProperty</tt>), or to alter the tolerance of its property object (via <tt>property().setTolerance(...)</tt>) will throw an exception.
...
/**
Constructs and returns a new row and column permuted <i>selection view</i> of matrix <tt>A</tt>; equivalent to {@link cern.colt.matrix.DoubleMatrix2D#viewSelection(int[],int[])}.
 ...
 * @see #setProperty(cern.colt.matrix.linalg.Property)
 */
...
Equivalent to {@link cern.colt.matrix.DoubleMatrix2D#viewDice A.viewDice()}.
...
@see #triangulateLower(cern.colt.matrix.DoubleMatrix2D)
*/
