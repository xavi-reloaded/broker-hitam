...
<table border="0" cellspacing="0">
  ...
  <tr align="left" valign="top"> 
	...
	<td>Use methods {@link #appendColumns(cern.colt.matrix.ObjectMatrix2D, cern.colt.matrix.ObjectMatrix2D) appendColumns},
	  {@link #appendColumns(cern.colt.matrix.ObjectMatrix2D, cern.colt.matrix.ObjectMatrix2D) appendRows} and {@link
	  #repeat(cern.colt.matrix.ObjectMatrix2D,int,int) repeat} to append rows and columns. </td>
  </tr>
  <tr align="left" valign="top"> 
	<td><i> General block matrices </i></td>
	<td>Use methods {@link #compose(cern.colt.matrix.ObjectMatrix2D[][]) compose} and {@link #decompose(cern.colt.matrix.ObjectMatrix2D[][], cern.colt.matrix.ObjectMatrix2D)
	  decompose} to work with general block matrices. </td>
  </tr>
  <tr align="left" valign="top"> 
	<td><i> Diagonal block matrices </i></td>
	<td>Use method {@link #composeDiagonal(cern.colt.matrix.ObjectMatrix2D, cern.colt.matrix.ObjectMatrix2D, cern.colt.matrix.ObjectMatrix2D)
...
The inverse to method {@link #decompose(cern.colt.matrix.ObjectMatrix2D[][], cern.colt.matrix.ObjectMatrix2D)}.
<p>
...
The inverse to method {@link #compose(cern.colt.matrix.ObjectMatrix2D[][])}.
<p>
All matrices of a given column within <tt>parts</tt> must have the same number of columns.
All matrices of a given row within <tt>parts</tt> must have the same number of rows.
Otherwise an <tt>IllegalArgumentException</tt> is thrown. 
