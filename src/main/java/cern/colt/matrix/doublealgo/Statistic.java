 ...
 */
abstract public double apply(DoubleMatrix1D x, DoubleMatrix1D y);
}
 ...
 * 
 * @param covariance a covariance matrix, as, for example, returned by method {@link #covariance(cern.colt.matrix.DoubleMatrix2D)}.
