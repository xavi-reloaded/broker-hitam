...
For an example, see {@link cern.colt.matrix.DoubleMatrix2D#getNonZeros(IntArrayList,IntArrayList,DoubleArrayList)}.
...
For an example see {@link cern.colt.matrix.DoubleMatrix2D#viewSelection(int[],int[])}.
<p>
...
For further information, see {@link cern.colt.matrix.doublealgo.Sorting#sort(cern.colt.matrix.DoubleMatrix3D,int,int)}.
