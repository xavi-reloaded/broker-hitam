...
<p> Lets call the generic data <tt>g</tt> (it may be one array, three linked lists 
  ...
  <tt>(a,b)</tt>, namely an {@link cern.colt.function.IntComparator}. The comparison function determines
  ...
  with the data at index <tt>b</tt>. It calls a user provided {@link Swapper}
...
<p> Sorts involving floating point data and not involving comparators, like, for 
  ...
  Sorting} handle floating point numbers in special ways to guarantee
 ...
 *                 <code>true</code>.
 * @see cern.colt.Sorting#upper_bound
 * @see cern.colt.Sorting#equal_range
 * @see cern.colt.Sorting#binary_search
 */
 ...
 *
 * @see cern.colt.function.IntComparator
 ...
 *                 <code>false</code>.
 * @see cern.colt.Sorting#lower_bound
 * @see cern.colt.Sorting#equal_range
 * @see cern.colt.Sorting#binary_search
 */
