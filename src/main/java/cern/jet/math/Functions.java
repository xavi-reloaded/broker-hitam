...
the first or the second argument. See methods {@link #bindArg1(cern.colt.function.DoubleDoubleFunction,double)}
and {@link #bindArg2(cern.colt.function.DoubleDoubleFunction,double)}. The order of arguments
can be swapped so that the first argument becomes the second and vice-versa. See 
method {@link #swapArgs(cern.colt.function.DoubleDoubleFunction)}. Example:
<ul>
<li><tt>Functions.pow</tt> gives the function <tt>a<sup>b</sup></tt>.
...
<li><tt>Functions.chain(g,h);</tt>
  ...
  can be generated via {@link #chain(cern.colt.function.DoubleFunction, cern.colt.function.DoubleDoubleFunction)}:
<ul>
<li><tt>Functions.chain(g,f);</tt>
</ul>
  The binary function <tt>f(g(a),h(b))</tt> 
  can be generated via {@link #chain(cern.colt.function.DoubleDoubleFunction, cern.colt.function.DoubleFunction, cern.colt.function.DoubleFunction)}:
<ul>
