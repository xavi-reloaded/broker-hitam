...
public class Descriptive extends Object {
	...
	*/
     ...
     *
     * @param sumOfPowers <tt>sumOfPowers[m] == Sum( data[i]<sup>m</sup>) )</tt> for <tt>m = 0,1,..,k</tt> as returned by method {@link #incrementalUpdateSumsOfPowers(cern.colt.list.DoubleArrayList,int,int,int,int,double[])}.
